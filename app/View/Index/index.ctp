...
<main id="main-container">
	...
	<section class="howto">
		...
		<p><?php echo __("Let me tell you. Oh My Timeline! creates automatically <br><b>a list on your Twitter profile with the people you follow:</b>"); ?></p>

		<img src="<?php echo Router::url("/") ?>img/OMT-follow-to-list-members-<?php echo Functions::getCurrentLanguage(); ?>.jpg" alt="<?php echo __("People you follow -> List members"); ?>"/>

		<p><?php echo __("And so, when browsing the list, <br><b>you'll browse a clean and sorted version of your timeline:</b>"); ?></p>

		<video controls autoplay loop>
			<source src="<?php echo Router::url("/") ?>img/final.mp4" type="video/mp4">
		</video>

		<p class="little"><?php echo __("Cause Twitter lists don't include ads, nor they use any algorithms.<br>Just the tweets from its members sorted in real time."); ?></p>
	...
	<section class="reviews">
		...
		<div class="reviews-carousel owl-carousel owl-theme">
			...
			<div class="review">
				...
				<div class="text">
					<?php echo __("<div class='previous'>\"I've been testing Oh My Timeline for a few days and I just can say it's amazing! Go checkout and enjoy your TL with\"</div>no ads!"); ?>
				</div>

				<div class="from"><?php echo __("Iñi, basque software developer"); ?></div>
			...
			<div class="review">
				...
				<div class="text">
					...
					<?php echo __("<div class='previous'>\"Ok, I won't use OMT! because I actually like Twitter's current timeline. In any case, I don't have any problem on it existing.\"</div>"); ?>¯\_(ツ)_/¯

				</div>

				<div class="from"><?php echo __("Gonzalo, basque software developer"); ?></div>
		...
		<div class="container">
			...
			<div class="follow-container">
				...
				<h4>
					...
					<p><?php echo __("For <span class='smaller'>s̶h̶i̶t̶t̶y̶</span> delicious tweets about side projects,<br>creativeness, UX, MEMEs...and to let me know<br> how Oh My Timeline! works for you!"); ?></p>
				</h4>
			</div>
